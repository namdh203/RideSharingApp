package com.ridesharingapp.common.google
...
class GoogleService(
    ...
    suspend fun getPlaceCoordinates(placeId: String): ServiceResult<FetchPlaceResponse?> = withContext(
        Dispatchers.IO) {
    ...
    suspend fun getDistanceBetween(userLatLng: LatLng, comparedTo: LatLng): String = withContext(
        Dispatchers.IO) {
